  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Welcome to HocxHire. By using our website, you agree to comply with
        ...
        <p>
          ...
          misuse or interfere with its operation.
        </p>

        <h2>Intellectual Property</h2>
        <p>
          All content on this site is the property of HocxHire and protected by
          copyright laws.
        </p>

        <h2>Limitation of Liability</h2>
        <p>
          HocxHire is not liable for any damages resulting from the use of our
          website.
        </p>
